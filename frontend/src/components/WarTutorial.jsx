...
const STEPS = [
    ...
    body: (
      <>
        <p>
          ...
          sobre el mapa, igual que en el clásico juego de mesa <em>Risk</em>.
        </p>
        <div className="tutorial-step-icon">🌍</div>
        <p>
          Tu misión: dominar el mapa con tu facción. Cada paso cuenta.
    ...
    body: (
      <>
        <p>
          ...
          un color que indica qué facción la controla:
        </p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          El poder determina tu fuerza en batalla. Cuanto más camines,
          más temible será tu ejército. La barra superior muestra tus estadísticas:
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          No puedes conquistar solo. <strong>Funda una facción</strong> o
          {' '}<strong>jura lealtad</strong> a una existente.
        </p>
        <div className="tutorial-step-icon">👑</div>
        <p>
          El poder de todos los miembros de tu facción se suma para las batallas.
          Usa el botón <strong>&ldquo;Facciones&rdquo;</strong> en la parte inferior
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          Cuando estés dentro de un territorio enemigo, pulsa
        ...
        <p>
          ...
          Se comparan de mayor a menor. ¡Que la estrategia y la suerte estén de tu lado!
        </p>
        <p>
          También puedes <strong>pedir consejo</strong> a tu asesor de guerra antes de atacar.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          Ya conoces las reglas del campo de batalla. Ahora sal ahí fuera,
          camina, reúne a tu facción y conquista la ciudad.
        </p>
        <div className="tutorial-step-icon">⚔️🌍🏆</div>
        <p style={{ fontStyle: 'italic', textAlign: 'center', color: '#6b5a4e' }}>
          &ldquo;La victoria pertenece a quien camina más lejos.&rdquo;
        </p>
      </>
    ),
  },
