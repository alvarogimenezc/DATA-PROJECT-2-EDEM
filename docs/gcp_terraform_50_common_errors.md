...
**Síntoma:** job falla instantáneamente, logs sólo dicen "Failed to read the result file".
...
7. `terraform plan -var-file=terraform.tfvars` — lee los avisos, no sólo el sumario.
