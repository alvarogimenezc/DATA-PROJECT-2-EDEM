...
VALENCIA_ZONES = [
    ...
    _z("zona-lhort-de-senabre",   "l'Hort de Senabre",          4),
    _z("zona-la-raiosa",           "la Raïosa",                   4),
    # Jesus
    _z("zona-malilla",             "Malilla",                     5),
    _z("zona-en-corts",            "En Corts",                    4),
    _z("zona-montolivet",          "Montolivet",                  4),
    _z("zona-la-fonteta-de-sant-lluis",          "la Fonteta de Sant Lluís",    4),
    _z("zona-na-rovella",          "Na Rovella",                  4),
    _z("zona-la-punta",            "la Punta",                    4),
    _z("zona-ciutat-de-les-arts-i-de-les-ciencies",         "Ciutat de les Arts i de les Ciències", 5),
    # Quatre Carreres
    _z("zona-natzaret",            "Natzaret",                    4),
    _z("zona-pinedo",              "Pinedo",                      3),
    _z("zona-el-castellar-loliveral",        "el Castellar - l'Oliveral",   3),
    _z("zona-el-forn-dalcedo",    "el Forn d'Alcedo",            3),
    _z("zona-la-torre",            "la Torre",                    3),
    _z("zona-faitanar",            "Faitanar",                    2),
    # Poblats Maritims
    _z("zona-el-grau",             "el Grau",                     5),
    _z("zona-el-cabanyal-el-canyamelar",         "el Cabanyal - el Canyamelar", 6),
    _z("zona-la-malvarosa",       "la Malva-rosa",               4),
    _z("zona-betero",              "Beteró",                      4),
    _z("zona-la-creu-del-grau",          "la Creu del Grau",            4),
    _z("zona-cami-fondo",          "Camí Fondo",                  4),
    _z("zona-penyaroja",          "Penya-roja",                  4),
    _z("zona-albors",              "Albors",                      4),
    _z("zona-la-carrasca",         "la Carrasca",                 4),
    _z("zona-aiora",               "Aiora",                       4),
    _z("zona-la-vega-baixa",       "la Vega Baixa",               4),
    _z("zona-lamistat",           "l'Amistat",                   4),
    _z("zona-ciutat-jardi",        "Ciutat Jardí",                4),
    _z("zona-lilla-perduda",      "l'Illa Perduda",              4),
    # Rascanya
    ...
    _z("zona-borboto",              "Borbotó",                     3),
    # Mauella y les Cases de Bàrcena eliminadas: son zonas geográficamente
    # aisladas sin adyacencia en el geojson de Valencia — quedaban como
    # "regalo gratis" conquistable sin vecinos y rompían la mecánica Risk.
    _z("zona-carpesa",             "Carpesa",                     3),
    _z("zona-poble-nou",           "Poble Nou",                   3),
    # Poblats de l'Oest
    _z("zona-beniferri",           "Beniferri",                   3),
    _z("zona-benimamet",           "Benimàmet",                   4),
    # Poblats del Sud
